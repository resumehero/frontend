...
import { resumePermissionMatrix, resumePermissionType } from '@directives/has-permissions/permission-matrix/_resume.permission-matrix';

export type permissionType = profilePermissionType | notificationsPermissionType | resumePermissionType;
